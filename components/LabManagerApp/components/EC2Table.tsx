...
const EC2Table: React.FC<EC2TableProps> = ({ email, instances, setInstances, loading, rawUsageSummary, fetchUsageSummary, isRefreshingUsage }) => {
  ...
  const toggleUsageDetails = (instanceId: string) => {
  ...
  const renderCopyField = (text: string, fieldId: string, truncate?: boolean) => {
    ...
    return (
      <div className="relative inline-flex items-center">
        ...
        <div
          onClick={() => handleCopy(text, fieldId)} // Always copy the full text
  ...
  const toggleExpiryColumn = (serviceType: string) => {
  ...
  const handleSelectAllForServiceType = (serviceType: string, checked: boolean) => {
          ...
          <div key={serviceType} style={{ marginBottom: 40 }}>
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={() => toggleExpiryColumn(serviceType)}
                  ...
                  <tr style={{ backgroundColor: "#f1f5f9", textAlign: "left" }}>
                    <th style={{ padding: "10px", width: "40px" }}>
                      <input
                        ...
                        onChange={(e) => handleSelectAllForServiceType(serviceType, e.target.checked)}
                        className="rounded"
                      />
                    </th>
                        ...
                        <tr style={{ borderTop: "1px solid #e5e7eb" }}>
                          <td style={{ padding: "10px" }}>
                            <input
                              type="checkbox"
                              checked={isSelected}
                              onChange={(e) => handleInstanceSelection(inst.InstanceId, e.target.checked)}
                              className="rounded"
                            />
                          </td>
                          <td style={{ padding: "10px" }}>
                          ...
                          {showExpiryColumn[serviceType] && (
                            <td style={{ padding: "10px" }}>
                              <div className="flex items-center gap-2">
                                ...
                                <button
                                  onClick={() => toggleUsageDetails(inst.InstanceId)}
                                  className="p-1 rounded-full hover:bg-gray-100 text-gray-500 transition-colors"
                                  title="Toggle Usage Details"
                                >
                              ...
                              <td colSpan={showExpiryColumn[serviceType] ? 8 : 7} style={{ padding: "10px 10px 10px 20px" }}>
                                <div className="text-sm">
                                  <div className="flex justify-between items-center mb-2">
                                    ...
                                    <button
                                      onClick={fetchUsageSummary} // Call the passed function
